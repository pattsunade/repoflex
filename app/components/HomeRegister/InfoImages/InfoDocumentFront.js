...
export default function InfoDocumentFront (props) {

    const {isVisibleInfoDocumentFront,setIsVisibleInfoDocumentFront} = props;

    return (
    
        <Modal isVisible={isVisibleInfoDocumentFront} setIsVisible={setIsVisibleInfoDocumentFront} >
        ...
        <View>
            ...
            <Icon 
                ...
                onPress={()=> setIsVisibleInfoDocumentFront(false)}

            /> 
            <Image 
                source={require("../../../../assets/img/El_ejemplo_de_Cedula_identidad_Chile_2013.jpg")}
                resizeMode="contain"
                style={styles.logo}
            />
