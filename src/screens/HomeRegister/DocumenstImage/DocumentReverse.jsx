...
function DocumentReverse({mode}) {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.description}>Verificaremos que la fotografía coincida con el reverso de la cédula de identidad.</Text>
            ...
            <TouchableOpacity style={styles.touchButtonStyle} onPress={openCamera}>
